...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYm9zaGFuNTUiLCJhIjoiY2thbDlkMGl3MHNpODMwdGRoZmVqYTlucyJ9.X4bHPIwECe7JLa9BVAFaTg';
...
exports.passwordReset = exports.forgotPassword = exports.logout = exports.login = void 0;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Instructions have been sent to your email!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var passwordReset = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(token, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successful!, redirecting to homepage');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function passwordReset(_x4, _x5, _x6) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Welcome email has been sent! Redirecting to your profile page');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_YQZn4NjHVf0gJQMNwWzCDj0C00wzvqx6Rg');
...
var PasswordForgotForm = document.querySelector('.form--forgot-password');
...
if (PasswordResetForm) PasswordResetForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (PasswordForgotForm) PasswordForgotForm.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); // @todo improve file upload ux 
